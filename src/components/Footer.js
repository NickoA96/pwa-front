    ...
    <div>
      <MDBFooter className=' text-center' color='white' bgColor='dark'>
        ...
        <div className='text-center p-3 fw-bold' style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
            © {año}  Libre Market by Nicolas Albornoz - hrefdos los derechos reservados
        </div>
        
        <div div className ="d-flex justify-content-end" >
        <a href="https://github.com/NickoA96" className='mt-0 mb-0 m-2'><i class="fa-brands fa-github"></i></a>
